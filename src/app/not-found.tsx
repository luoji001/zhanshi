 ...
 * 本文件走根 layout，因此 globals.css 的令牌、字体、color-scheme，以及顶栏页脚
 * （SiteHeader / SiteFooter）都照常生效。
 *
 * 顶栏虽然已经给出回去的路，这一页仍保留自己的两个按钮：404 上「点错了」的访客
 * 需要的是一个就近、明确的去处，而不是去顶栏里找导航。两个链接各指一个真实页面。
 */
